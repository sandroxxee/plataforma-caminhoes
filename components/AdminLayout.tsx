  ...
  return (
    <main className="admin-page">
      ...
      <style>{`
        ...
        .shield{fill:#ffffff}.check{fill:none;stroke:#ffffff;stroke-width:3;stroke-linecap:round;stroke-linejoin:round}
        .admin-brand strong{display:block;font-size:15px;line-height:1.1;color:#111827}
        ...
        .admin-menu a.active{box-shadow:inset 4px 0 0 #1f64b5}
        .admin-bottom{margin-top:auto;display:grid;gap:10px}.admin-bottom form{margin:0}
        .admin-public{font-weight:900;background:#f8fafc;color:#111827}
        .admin-logout{color:#b42318;background:#fff5f5;border-color:#ffd1d1;font-weight:900}

        .admin-content{padding:28px 40px;min-width:0}
        .admin-header{
          min-height:auto;
          padding:22px 24px;
          border-radius:22px;
        ...
        .admin-header h1{margin:10px 0 6px;font-size:clamp(26px,3vw,36px);line-height:1.06;letter-spacing:-.035em;color:#111827}
        .admin-header p{margin:0;color:#64748b;line-height:1.5;max-width:760px}
        .admin-body{min-width:0}

        @media(max-width:900px){
          .admin-page{display:block}
          .admin-sidebar{position:sticky;top:0;z-index:20;height:auto;padding:12px;border-right:0;border-bottom:1px solid #d8dee9;gap:12px}
          .admin-brand{padding:12px}.admin-brand-icon{width:38px;height:38px}.admin-brand-icon svg{width:26px;height:26px}.admin-brand small{display:none}
          ...
          .admin-header{padding:18px;border-radius:18px;display:grid;gap:14px;margin-bottom:16px}
