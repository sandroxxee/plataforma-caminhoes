...
export function HeroMarketplace() {
  return (
    <div className="hero-wrap">
      <img src="/hero-home.jpg" alt="" className="hero-img" aria-hidden="true" />
      ...
      <div className="hero-body">
        ...
        <div className="hero-links">
          ...
          <Link href="/cadastro" className="hero-link hero-link-primary">Anunciar meu caminh&atilde;o</Link>
        </div>
      </div>
    </div>
  );
