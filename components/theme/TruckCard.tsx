    ...
    >
      ...
      <style>{`
        ...
        .tc-photo {
          ...
          background: var(--soft); text-decoration: none; flex-shrink: 0;
        }
        ...
        .tc-loc {
          ...
          text-shadow: 0 1px 4px rgba(0,0,0,.4); white-space: nowrap;
        }
        ...
        .tc-name {
          margin: 0; font-size: 13px; font-weight: 800; color: var(--text);
        ...
        .tc-meta { margin: 0; font-size: 11px; font-weight: 700; color: var(--muted); }
        .tc-views {
          display: inline-flex; align-items: center; gap: 3px;
        ...
        .tc-btn:hover {
          ...
          box-shadow: 0 5px 16px rgba(24,119,242,.38);
        }
