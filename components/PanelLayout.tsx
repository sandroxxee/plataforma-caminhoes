...
export function PanelLayout({ title, subtitle, badge, actions, children }: Props) {
  return (
    <main className="panel-page">
      ...
      <style>{`
        .panel-page{--panel-bg:#111315;--panel-side:#181b1e;--panel-card:#1f2327;--panel-soft:#2a2f34;--panel-line:#343a40;--panel-text:#e8eaed;--panel-title:#f4f4f5;--panel-muted:#a7afb7;--panel-muted2:#8f99a3;--panel-green:#22c55e;--panel-green-soft:#19251d;--panel-green-text:#d9ffe7;--panel-red-bg:#35191b;--panel-red:#fecaca;min-height:100vh;display:grid;grid-template-columns:272px 1fr;background:var(--panel-bg);color:var(--panel-text)}html[data-theme="light"] .panel-page{--panel-bg:#f3f6fb;--panel-side:#ffffff;--panel-card:#ffffff;--panel-soft:#eef2f7;--panel-line:#d8dee9;--panel-text:#334155;--panel-title:#111827;--panel-muted:#64748b;--panel-muted2:#64748b;--panel-green:#16a34a;--panel-green-soft:#e7f8ef;--panel-green-text:#166534;--panel-red-bg:#fff5f5;--panel-red:#b42318}.panel-sidebar{position:sticky;top:0;height:100vh;padding:22px;border-right:1px solid var(--panel-line);background:var(--panel-side);display:flex;flex-direction:column;gap:18px;overflow-y:auto}.panel-brand{display:flex;align-items:center;gap:12px;padding:14px;border-radius:18px;background:var(--panel-card);border:1px solid var(--panel-line);color:var(--panel-text);text-decoration:none}.panel-brand-icon{width:46px;height:46px;border-radius:14px;display:grid;place-items:center;background:var(--panel-green);color:#06140b;flex:0 0 auto;overflow:hidden}.panel-brand-icon svg{width:32px;height:32px;display:block}.truck-body,.truck-cabin{fill:#06140b}.truck-line,.truck-road{fill:none;stroke:#14532d;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.truck-wheel{fill:#06140b;stroke:var(--panel-green);stroke-width:1.5}.panel-brand strong{display:block;font-size:15px;line-height:1.1;letter-spacing:-.02em;color:var(--panel-title)}.panel-brand small{display:block;color:var(--panel-muted);font-size:12px;margin-top:4px;font-weight:800}.panel-menu{display:grid;gap:8px}.panel-menu-link,.panel-public,.panel-logout,.theme-toggle{width:100%;min-height:50px;padding:11px 12px;border-radius:14px;color:var(--panel-text);background:var(--panel-card);border:1px solid var(--panel-line);text-decoration:none;font-weight:800;display:flex;align-items:center;gap:11px;text-align:left;cursor:pointer;font-family:inherit;transition:background .18s ease,border-color .18s ease,color .18s ease}.panel-menu-link:hover,.panel-public:hover,.theme-toggle:hover{background:var(--panel-green-soft);border-color:var(--panel-green);color:var(--panel-green-text)}.panel-menu-link.active{background:var(--panel-green-soft);border-color:var(--panel-green);color:var(--panel-green-text);box-shadow:inset 4px 0 0 var(--panel-green)}.panel-menu-icon{width:34px;height:34px;border-radius:12px;display:grid;place-items:center;background:var(--panel-soft);color:var(--panel-green);font-weight:950;flex:0 0 auto}.panel-menu-link.active .panel-menu-icon{background:var(--panel-green);color:#06140b}.panel-menu-link strong{display:block;font-size:14px;line-height:1.15}.panel-menu-link small{display:block;margin-top:3px;color:var(--panel-muted2);font-size:12px;font-weight:800}.panel-menu-link.active small{color:var(--panel-green-text)}.panel-bottom{margin-top:auto;display:grid;gap:10px}.panel-bottom form{margin:0}.panel-public,.theme-toggle{justify-content:center;text-align:center;min-height:46px;font-weight:900}.panel-logout{justify-content:center;text-align:center;min-height:46px;color:var(--panel-red);background:var(--panel-red-bg);border-color:#7f1d1d;font-weight:900}.panel-content{padding:28px 40px;min-width:0}.panel-header{min-height:auto;padding:22px 24px;border-radius:22px;background:var(--panel-card);border:1px solid var(--panel-line);display:flex;justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:22px;box-shadow:0 16px 34px rgba(0,0,0,.18)}html[data-theme="light"] .panel-header{box-shadow:0 8px 22px rgba(15,23,42,.05)}.panel-badge{display:inline-flex;padding:6px 10px;border-radius:999px;background:var(--panel-green-soft);color:var(--panel-green-text);border:1px solid var(--panel-green);font-weight:900;font-size:12px;text-transform:uppercase}.panel-header h1{margin:10px 0 6px;font-size:clamp(26px,3vw,36px);line-height:1.06;letter-spacing:-.035em;color:var(--panel-title)}.panel-header p{margin:0;color:var(--panel-muted);line-height:1.5;max-width:760px}.panel-body{min-width:0}@media(max-width:980px){.panel-page{display:block}.panel-sidebar{position:sticky;top:0;z-index:20;height:auto;padding:12px;border-right:0;border-bottom:1px solid var(--panel-line);gap:10px}.panel-brand{padding:10px}.panel-brand-icon{width:40px;height:40px;border-radius:14px}.panel-brand-icon svg{width:29px;height:29px}.panel-menu{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.panel-menu-link{min-height:54px;justify-content:center;text-align:center;padding:9px}.panel-menu-icon,.panel-menu-link small{display:none}.panel-bottom{grid-template-columns:1fr 1fr;gap:8px;margin-top:0}.panel-public,.panel-logout,.theme-toggle{min-height:42px;padding:10px 12px;font-size:14px}.panel-content{padding:16px 12px 28px}.panel-header{padding:18px;border-radius:18px;display:grid;gap:14px;margin-bottom:16px}.panel-actions,.panel-actions a,.panel-actions button{width:100%}.panel-body{overflow-x:auto}}@media(max-width:520px){.panel-sidebar{padding:10px}.panel-brand strong{font-size:14px}.panel-brand small{display:none}.panel-menu{grid-template-columns:1fr}.panel-menu-link{justify-content:flex-start;text-align:left;min-height:46px}.panel-menu-icon{display:grid;width:32px;height:32px}.panel-header h1{font-size:25px}}
      `}</style>
    </main>
  );
}
