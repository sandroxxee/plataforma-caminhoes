...
export function PublicHeader() {
  ...
  return (
    <header className="public-header">
      ...
      <style>{`
        .public-header{position:sticky;top:0;z-index:80;background:rgba(255,255,255,.98);border-bottom:1px solid var(--border);box-shadow:0 1px 4px rgba(0,0,0,.05);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px)}
        .public-header-shell{width:min(1240px,calc(100vw - 28px));min-height:68px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;gap:18px}
        .public-brand{display:flex;align-items:center;gap:10px;flex:0 0 auto;min-width:230px;color:var(--text);text-decoration:none}.brand-badge{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:var(--primary);color:#fff;box-shadow:0 8px 18px rgba(24,119,242,.2)}.brand-text{display:grid;gap:0}.brand-text img{width:176px;height:40px;object-fit:contain;object-position:left center;display:block}.brand-text small{color:var(--muted);font-size:12px;font-weight:800;margin-top:-4px}
        .public-nav{flex:1 1 auto;display:flex;align-items:center;justify-content:center;gap:4px;min-width:0}.public-nav a{min-height:42px;display:inline-flex;align-items:center;justify-content:center;gap:7px;padding:0 11px;border-radius:12px;color:var(--muted);font-size:13px;font-weight:900;white-space:nowrap;text-decoration:none;transition:.18s ease}.public-nav a:hover,.public-nav a.active{background:#e7f3ff;color:var(--primary)}
        .public-right{flex:0 0 auto;display:flex;align-items:center;justify-content:flex-end;gap:10px;min-width:230px}.desktop-search{width:150px;height:42px;border-radius:999px;background:var(--surface-soft);border:1px solid transparent;display:flex;align-items:center;gap:7px;padding:0 12px;color:var(--muted)}.desktop-search:focus-within{background:var(--surface);border-color:var(--primary);box-shadow:0 0 0 3px rgba(24,119,242,.12)}.desktop-search input{width:100%;min-width:0;border:0;outline:0;background:transparent;color:var(--text);font-weight:750}.desktop-search input::placeholder{color:var(--muted)}
        .public-actions{display:flex;align-items:center;justify-content:flex-end;gap:8px;white-space:nowrap}.public-login,.menu-toggle,.search-toggle{min-height:42px;display:inline-flex;align-items:center;justify-content:center;gap:8px;border-radius:12px;font-size:13px;font-weight:900;text-decoration:none;transition:.18s ease}.public-login{padding:0 14px;background:var(--primary);border:1px solid var(--primary);color:#fff;box-shadow:0 7px 16px rgba(24,119,242,.16)}.search-toggle,.menu-toggle{border:1px solid var(--border);background:var(--surface-soft);color:var(--text);cursor:pointer;width:42px}.public-login:hover,.menu-toggle:hover,.search-toggle:hover{transform:translateY(-1px)}.menu-toggle,.search-toggle{display:none}
