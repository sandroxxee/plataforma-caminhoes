...
export function PublicHeader() {
  ...
  return (
    <header className="public-header">
      ...
      <style>{`
        .public-header{position:sticky;top:0;z-index:80;background:rgba(255,255,255,.97);border-bottom:1px solid var(--border);box-shadow:0 1px 4px rgba(0,0,0,.05);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px)}
        ...
        .public-brand{display:flex;align-items:center;gap:10px;min-width:max-content;color:var(--text);text-decoration:none}.brand-badge{width:44px;height:44px;border-radius:50%;display:grid;place-items:center;background:var(--primary);color:#fff;box-shadow:0 8px 18px rgba(24,119,242,.2)}.brand-text{display:grid;gap:0}.brand-text img{width:185px;height:42px;object-fit:contain;object-position:left center;display:block}.brand-text small{color:var(--muted);font-size:12px;font-weight:800;margin-top:-3px}
