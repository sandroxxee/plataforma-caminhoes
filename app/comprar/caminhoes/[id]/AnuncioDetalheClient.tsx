...
export function AnuncioAsideActions({ truckId, title, whatsappLink, shareText, whatsappLabel }: AsideActionsProps) {
  const label = whatsappLabel || "Tenho interesse neste caminhão";

  // Sticky bar no mobile: aparece após rolar 300px
    ...
    <>
      ...
      {whatsappLink && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className={`detail-wa-sticky${showSticky ? " detail-wa-sticky--visible" : ""}`}
