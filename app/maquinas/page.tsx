...
export const metadata: Metadata = {
  ...
  description: "Veja máquinas pesadas à venda: escavadeiras, motoniveladoras, pás-carregadeiras, rolos compactadores e muito mais. Negociação direta pelo WhatsApp.",
  ...
  return (
    <div className="maq-page">
      ...
      <style>{`
        ...
        .maq-est-chip:hover, .maq-est-chip--active {
        ...
        @media (max-width: 680px) {
          .maq-cta-inner { flex-direction: column; align-items: flex-start; }
