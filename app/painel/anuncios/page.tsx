...
export default async function MeusAnunciosPage() {
  ...
  return (
    ...
    >
      ...
      <style>{`
        .top-button{display:inline-flex;min-height:46px;align-items:center;justify-content:center;padding:0 16px;border-radius:14px;background:#1f64b5;color:#fff;text-decoration:none;font-weight:950}
        .my-listings{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}
        .listing-card{overflow:hidden;border-radius:22px;background:#fff;border:1px solid #d8dee9;box-shadow:0 8px 22px rgba(15,23,42,.05)}
        .listing-photo{position:relative;height:300px;background:#f4f7fb;display:grid;place-items:center;color:#64748b;font-weight:950;overflow:hidden;border-bottom:1px solid #e2e8f0}
        .listing-photo img{width:100%;height:100%;object-fit:contain;object-position:center center;display:block;background:#f4f7fb}
        .status{position:absolute;left:14px;top:14px;min-height:30px;display:inline-flex;align-items:center;padding:0 11px;border-radius:999px;font-size:12px;font-style:normal;font-weight:950;border:1px solid rgba(255,255,255,.7);box-shadow:0 6px 18px rgba(15,23,42,.10)}
        .status.approved{background:#e7f8ef;color:#166534}.status.pending{background:#fff7df;color:#92400e}.status.rejected{background:#fff1f1;color:#b42318}.status.sold{background:#eef2f7;color:#334155}
        ...
        .listing-actions{padding:0 18px 18px;display:grid;grid-template-columns:1fr auto;gap:10px;align-items:center}.listing-actions form{margin:0}.edit-action{min-height:42px;display:inline-flex;align-items:center;justify-content:center;padding:0 14px;border-radius:13px;background:#eef2f7;border:1px solid #d8dee9;color:#334155;text-decoration:none;font-weight:950}
        .empty-state-panel{grid-column:1/-1;padding:32px;border-radius:22px;background:#fff;border:1px solid #d8dee9;text-align:center;box-shadow:0 8px 22px rgba(15,23,42,.05)}.empty-state-panel span{display:block;font-size:42px;margin-bottom:12px}.empty-state-panel h2{margin:0 0 8px;font-size:26px;color:#111827}.empty-state-panel p{margin:0 auto 18px;color:#64748b;max-width:520px;line-height:1.55}.empty-state-panel a{display:inline-flex;min-height:46px;align-items:center;justify-content:center;padding:0 18px;border-radius:14px;background:#1f64b5;color:#fff;text-decoration:none;font-weight:950}
