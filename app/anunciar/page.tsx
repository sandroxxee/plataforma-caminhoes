...
export const metadata: Metadata = {
  ...
  description:
    "Publique seu anúncio grátis em minutos. Cole o texto do seu anúncio e a IA preenche tudo automaticamente. Comprador direto, sem intermediários.",
  openGraph: {
    ...
    <main className="lp-wrap">
      ...
      <style jsx>{`
        ...
        .cta-final {
          ...
          padding: 80px 20px;
          gap: 16px;
          background: linear-gradient(180deg, #030712 0%, #052e16 100%);
        }
        .cta-title {
