...
/** Galeria + contador de views — apenas o que precisa de browser */
...
/** Botões de ação do aside: WhatsApp + compartilhar */
export function AnuncioAsideActions({ truckId, title, whatsappLink, shareText }: AsideActionsProps) {
  return (
    <>
      {whatsappLink && (
        <a
