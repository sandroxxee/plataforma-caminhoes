  ...
  return (
    <main style={styles.page}>
      <header style={styles.header}>
        <Link href="/" style={styles.logoBox}>
          ...
          <span>
            ...
            <small style={styles.logoSmall}>Anúncios reais do Supabase</small>
          </span>
        </Link>

        <nav style={styles.nav}>
          <Link href="/anuncios" style={styles.navLink}>Anúncios</Link>
      ...
      <section style={styles.hero}>
        <span style={styles.badge}>SITE PÚBLICO</span>
        <h1 style={styles.title}>Caminhões à venda</h1>
        <p style={styles.subtitle}>
          Esta página mostra somente anúncios reais do banco com status aprovado.
        </p>
      </section>
      ...
      <section style={styles.content}>
        <aside style={styles.filters}>
          ...
          <Link href="/cadastro" style={styles.filterButton}>Quero anunciar</Link>
        </aside>
        ...
        <div style={styles.results}>
          ...
          {trucks.length === 0 && (
            <div style={styles.emptyBox}>
              Nenhum anúncio aprovado no banco agora.
            </div>
          )}
        </div>
      </section>
