  ...
  return (
    <main className="stock-page">
      ...
      <section className="wrap stock-hero">
        <div>
          <span className="mini">Estoque da loja</span>
          <h1>Caminhões, implementos e carrocerias em formato marketplace.</h1>
      ...
      <form className="wrap stock-filters" action="/anuncios">
        <div className="field searchField">
          <label>Buscar</label>
          <input name="busca" defaultValue={busca} placeholder="Modelo, cidade, ano, carroceria..." />
        </div>
      ...
      <section className="wrap stock-title-row">
        <div>
          <span className="mini">{temFiltro ? "Resultado da busca" : "Anúncios"}</span>
      ...
      <style>{`
        .stock-page{min-height:100vh;color:var(--site-text);background:var(--site-bg);overflow-x:hidden;padding-bottom:30px}.wrap{width:min(1240px,calc(100vw - 28px));margin:0 auto}.mini{display:inline-flex;align-items:center;min-height:32px;padding:0 12px;border-radius:999px;background:var(--site-blue-soft);border:1px solid color-mix(in srgb,var(--site-blue) 22%,transparent);color:var(--site-blue);font-size:12px;font-weight:950;letter-spacing:.06em;text-transform:uppercase}.stock-hero{display:grid;grid-template-columns:minmax(0,1fr) 245px;gap:18px;align-items:stretch;margin-top:24px;padding:28px;border-radius:28px;background:linear-gradient(135deg,#fff 0%,#eef5ff 58%,#dcecff 100%);border:1px solid var(--site-line);box-shadow:var(--site-shadow-soft);overflow:hidden}html[data-theme="dark"] .stock-hero{background:linear-gradient(135deg,var(--site-surface),#172033 58%,#1e3a5f)}.stock-hero h1{margin:14px 0 10px;max-width:830px;font-size:clamp(34px,4.4vw,58px);line-height:.98;letter-spacing:-.06em}.stock-hero p{margin:0;max-width:760px;color:var(--site-muted);font-size:16px;line-height:1.55;font-weight:720}.stock-hero aside{display:flex;flex-direction:column;justify-content:flex-end;padding:20px;border-radius:22px;background:rgba(255,255,255,.72);border:1px solid var(--site-line)}html[data-theme="dark"] .stock-hero aside{background:rgba(255,255,255,.05)}.stock-hero aside strong{font-size:54px;line-height:.9;color:var(--site-blue);letter-spacing:-.06em}.stock-hero aside span{margin-top:8px;color:var(--site-muted);font-weight:900}.stock-filters{position:relative;z-index:5;margin:16px auto 28px;padding:12px;border-radius:22px;display:grid;grid-template-columns:minmax(220px,1.35fr) minmax(130px,.65fr) minmax(150px,.75fr) minmax(120px,.58fr) minmax(180px,.95fr) auto;gap:10px;background:var(--site-surface);border:1px solid var(--site-line);box-shadow:var(--site-shadow-soft)}.field{display:grid;gap:7px}.field label{font-size:12px;color:var(--site-muted);font-weight:950;letter-spacing:.04em;text-transform:uppercase}.field input,.field select{width:100%;min-height:46px;border-radius:12px;border:1px solid var(--site-line);background:var(--site-surface-2);color:var(--site-text);outline:0;padding:0 13px;font-weight:800}.filterActions{display:grid;grid-template-rows:1fr 1fr;gap:8px;align-self:end}.filterActions button,.filterActions a{min-width:92px;min-height:39px;border-radius:999px;border:0;display:inline-flex;align-items:center;justify-content:center;text-decoration:none;font-weight:950}.filterActions button{background:var(--site-blue);color:#fff}.filterActions a{background:var(--site-surface-2);color:var(--site-text);border:1px solid var(--site-line)}.stock-title-row{display:flex;align-items:end;justify-content:space-between;gap:18px;margin-bottom:16px}.stock-title-row h2{margin:10px 0 0;font-size:clamp(28px,3vw,42px);line-height:1.05;letter-spacing:-.045em}.stock-title-row>a{min-height:42px;border-radius:999px;background:var(--site-blue);color:#fff;padding:0 16px;display:inline-flex;align-items:center;text-decoration:none;font-weight:950}.stock-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:14px}.stock-card{overflow:hidden;border-radius:18px;background:var(--site-surface);border:1px solid var(--site-line);box-shadow:var(--site-shadow-soft);transition:.18s ease}.stock-card:hover{transform:translateY(-3px);box-shadow:var(--site-shadow)}.stock-photo{position:relative;aspect-ratio:1/1;background:var(--site-surface-2);display:grid;place-items:center;overflow:hidden;color:var(--site-muted);text-decoration:none;font-weight:950}.stock-photo img{width:100%;height:100%;object-fit:cover;object-position:center center;display:block}.stock-photo span{position:absolute;top:10px;left:10px;z-index:2;padding:6px 9px;border-radius:999px;background:rgba(5,5,5,.78);color:#fff;font-size:11px;font-weight:950}.stock-photo i{font-style:normal}.stock-card-body{padding:12px}.stock-card-body>strong{display:block;color:var(--site-text);font-size:20px;line-height:1.1;margin-bottom:6px}.stock-card-title{display:block;color:var(--site-text);font-size:16px;font-weight:950;line-height:1.15;text-decoration:none;letter-spacing:-.02em}.stock-card-meta{margin:7px 0 10px;color:var(--site-muted);font-size:13px}.stock-card-body p{margin:0 0 12px;color:var(--site-muted);font-size:13px;line-height:1.38;font-weight:680}.stock-card-actions{display:grid;grid-template-columns:1fr 1fr;gap:8px}.stock-card-actions a{min-height:39px;border-radius:10px;display:inline-flex;align-items:center;justify-content:center;padding:0 10px;text-decoration:none;font-weight:950;font-size:12px}.stock-card-actions a:first-child{background:var(--site-surface-2);border:1px solid var(--site-line);color:var(--site-text)}.stock-card-actions a:last-child{background:var(--site-green);color:#fff}.empty-stock{grid-column:1/-1;padding:30px;border-radius:22px;background:var(--site-surface);border:1px solid var(--site-line);box-shadow:var(--site-shadow-soft);text-align:center}.empty-stock h3{margin:0 0 8px;font-size:24px}.empty-stock p{margin:0 auto 16px;max-width:560px;color:var(--site-muted)}.empty-stock a{min-height:44px;border-radius:999px;background:var(--site-blue);color:#fff;padding:0 16px;display:inline-flex;align-items:center;text-decoration:none;font-weight:950}@media(max-width:1120px){.stock-grid{grid-template-columns:repeat(3,1fr)}.stock-filters{grid-template-columns:1fr 1fr}.filterActions{grid-template-columns:1fr 1fr;grid-template-rows:auto}}@media(max-width:780px){.stock-hero{grid-template-columns:1fr;padding:22px;border-radius:22px}.stock-grid{grid-template-columns:repeat(2,1fr)}.stock-title-row{align-items:stretch;flex-direction:column}.stock-title-row>a{justify-content:center}.stock-filters{grid-template-columns:1fr}.filterActions{grid-template-columns:1fr}}@media(max-width:520px){.wrap{width:min(100% - 22px,1240px)}.stock-hero h1{font-size:34px;letter-spacing:-.045em}.stock-grid{grid-template-columns:1fr}.stock-card-actions{grid-template-columns:1fr}.stock-card-actions a{width:100%}}
      `}</style>
    </main>
  );
}
